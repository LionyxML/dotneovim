...
--
-- This configuration uses the built-in vim.pack package manager (Neovim 0.12+).
-- All plugins load eagerly at startup (no lazy loading).
--
...
require("nvim-treesitter").install(tree_sitter_langs)

vim.api.nvim_create_autocmd("FileType", {
	pattern = tree_sitter_langs,
	callback = function()
		vim.treesitter.start()
	end,
})

-- If folding is desired, use the following:
